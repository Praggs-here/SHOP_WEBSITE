    ...
    <section className="py-16 sm:py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          <div>
            <h2 className="font-serif-custom text-3xl sm:text-4xl font-normal text-[#4A154B]">A Legacy of Ethnic Elegance</h2>
            ...
            <div className="mt-6">
              <Link to="/about" className="inline-block px-6 py-3 bg-[#4A154B] text-white rounded-full font-normal text-sm hover:bg-[#5C0632] transition-colors">DISCOVER OUR STORY</Link>
            </div>
          </div>
