        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-6 space-y-6">
            <div>
              ...
              <h2 className="font-serif-custom text-3xl sm:text-4xl font-bold text-[#4A154B] mt-1">
                VISIT OUR STORE
              </h2>
            ...
            <div className="space-y-4 bg-[#FFFDF9] p-6 rounded-2xl border border-[#E8D5C4] shadow-sm">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="text-xs font-bold uppercase text-[#4A154B] tracking-wider">Address</h4>
                  <p className="text-sm text-[#5C524E] font-medium leading-relaxed mt-0.5">
                    {storeAddress}
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3 pt-3 border-t border-[#F4EBE2]">
                ...
                <div>
                  <h4 className="text-xs font-bold uppercase text-[#4A154B] tracking-wider">Phone / WhatsApp</h4>
                  <a href={`tel:${phone}`} className="text-sm font-bold text-[#4A154B] hover:text-[#B38F38] transition-colors">
                    +91 {phone}
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3 pt-3 border-t border-[#F4EBE2]">
                ...
                <div>
                  <h4 className="text-xs font-bold uppercase text-[#4A154B] tracking-wider">Store Hours</h4>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4">
              <a
                href={`tel:${phone}`}
                className="w-full sm:w-auto px-7 py-3.5 bg-[#4A154B] hover:bg-[#5C0632] text-white text-xs font-bold uppercase tracking-widest rounded-full transition-all shadow-md flex items-center justify-center space-x-2"
              >
              ...
              <a
                ...
                className="w-full sm:w-auto px-7 py-3.5 bg-[#FFFDF9] hover:bg-[#F5F0EB] text-[#4A154B] border border-[#D9C8B4] text-xs font-bold uppercase tracking-widest rounded-full transition-all shadow-sm flex items-center justify-center space-x-2"
              >
            ...
            <div className="relative rounded-3xl overflow-hidden shadow-xl border-4 border-[#FFFDF9] bg-[#E8D5C4]/30 h-[360px] sm:h-[420px] flex flex-col justify-between p-6">
              ...
              <div className="relative z-10 flex justify-between items-start">
                <div className="bg-[#FFFDF9] px-4 py-2 rounded-xl shadow border border-[#E8D5C4]">
                  <span className="text-[10px] uppercase font-bold text-[#7A4C62] block">DELHI BOUTIQUE</span>
                  <span className="font-serif-custom text-base font-bold text-[#4A154B]">Mahavir Enclave, Palam</span>
                </div>
                <span className="px-3 py-1 bg-[#4A154B] text-white text-[10px] font-bold rounded-full uppercase tracking-wider">
                  VISIT US TODAY
                </span>
              </div>
              ...
              <div className="relative z-10 my-auto text-center">
                ...
                <h3 className="font-serif-custom text-xl font-bold text-[#4A154B] mt-3">
                  OM DIVINE INSPIRATIONS
                </h3>
                <p className="text-xs text-[#5C524E] font-medium max-w-xs mx-auto mt-1">
              ...
              <div className="relative z-10 text-center">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center px-5 py-2.5 bg-[#4A154B] hover:bg-[#5C0632] text-white text-xs font-bold uppercase tracking-widest rounded-full shadow"
                >
                  Open in Google Maps
                </a>
              </div>
